...
const Footer = () => {
  return (
    <footer className="bg-black dark:bg-gray-900 bt">
      <div className="mx-auto max-w-screen-xl px-4 pb-8 pt-20 sm:px-6 lg:px-8">
        ...
        <div className="mt-16 border-t border-gray-100 pt-8 dark:border-gray-800">
          <p className="text-center text-xs/relaxed text-white dark:text-gray-400">
            ...
            <a
              href="#"
              className="text-white underline transition hover:text-white/75 dark:text-white dark:hover:text-white/75"
            >
             Tejasvi Raj
            </a>
            and
